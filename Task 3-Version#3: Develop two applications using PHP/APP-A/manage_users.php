...
$response = SendCurl('http://backend.local/api/manage_users.php', $actiontype, $headers);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $actionresponse = SendCurl('http://backend.local/api/manage_users.php', $actionAdmin, $headers);

...
$response = SendCurl('http://backend.local/api/edit_profile.php', $xmlData->asXML(), $headers);
$fetchuser = ActionXml2('fetch_all_user', ['user_id' => $userID]);
...
$updateuser = ActionXml2('update_user', [
    'user_id'     => $userID,
    'username'    => $username,
    'email'       => $email,
    'password'    => $password,
